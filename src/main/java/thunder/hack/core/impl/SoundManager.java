...
import static thunder.hack.cmd.Command.sendMessage;
...
public final class SoundManager {
    public final Identifier KEYPRESS_SOUND = new Identifier("thunderhack:keypress");
    public SoundEvent KEYPRESS_SOUNDEVENT = SoundEvent.of(KEYPRESS_SOUND);
    public final Identifier KEYRELEASE_SOUND = new Identifier("thunderhack:keyrelease");
    public SoundEvent KEYRELEASE_SOUNDEVENT = SoundEvent.of(KEYRELEASE_SOUND);
    public final Identifier UWU_SOUND = new Identifier("thunderhack:uwu");
    public SoundEvent UWU_SOUNDEVENT = SoundEvent.of(UWU_SOUND);
    public final Identifier ENABLE_SOUND = new Identifier("thunderhack:enable");
    public SoundEvent ENABLE_SOUNDEVENT = SoundEvent.of(ENABLE_SOUND);
    public final Identifier DISABLE_SOUND = new Identifier("thunderhack:disable");
    public SoundEvent DISABLE_SOUNDEVENT = SoundEvent.of(DISABLE_SOUND);
    public final Identifier MOAN1_SOUND = new Identifier("thunderhack:moan1");
    public SoundEvent MOAN1_SOUNDEVENT = SoundEvent.of(MOAN1_SOUND);
    public final Identifier MOAN2_SOUND = new Identifier("thunderhack:moan2");
    public SoundEvent MOAN2_SOUNDEVENT = SoundEvent.of(MOAN2_SOUND);
    public final Identifier MOAN3_SOUND = new Identifier("thunderhack:moan3");
    public SoundEvent MOAN3_SOUNDEVENT = SoundEvent.of(MOAN3_SOUND);
    public final Identifier MOAN4_SOUND = new Identifier("thunderhack:moan4");
    public SoundEvent MOAN4_SOUNDEVENT = SoundEvent.of(MOAN4_SOUND);
    public final Identifier SKEET_SOUND = new Identifier("thunderhack:skeet");
    public SoundEvent SKEET_SOUNDEVENT = SoundEvent.of(SKEET_SOUND);
    public final Identifier ORTHODOX_SOUND = new Identifier("thunderhack:orthodox");
    public SoundEvent ORTHODOX_SOUNDEVENT = SoundEvent.of(ORTHODOX_SOUND);
    public final Identifier BOOLEAN_SOUND = new Identifier("thunderhack:boolean");
    public SoundEvent BOOLEAN_SOUNDEVENT = SoundEvent.of(BOOLEAN_SOUND);
    public final Identifier SCROLL_SOUND = new Identifier("thunderhack:scroll");
    public SoundEvent SCROLL_SOUNDEVENT = SoundEvent.of(SCROLL_SOUND);
    public final Identifier SWIPEIN_SOUND = new Identifier("thunderhack:swipein");
    public SoundEvent SWIPEIN_SOUNDEVENT = SoundEvent.of(SWIPEIN_SOUND);
    public final Identifier SWIPEOUT_SOUND = new Identifier("thunderhack:swipeout");
