    ...
    public void onRender2D(DrawContext context) {
        ...
        for (Module module : list) {
            ...
            if(HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                Render2DEngine.drawBlurredShadow(context.getMatrices(), reverse ? reversedX - stringWidth : getPosX(), getPosY() + offset, stringWidth + 1.0f, 9.0f, 2, HudEditor.blurColor.getValue().getColorObject());
            } else {
