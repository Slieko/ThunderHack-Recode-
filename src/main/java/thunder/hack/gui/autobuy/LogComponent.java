...
public class LogComponent {
    ...
    public void render(DrawContext context, int MouseX, int MouseY) {
        ...
        FontRenderers.modules.drawString(context.getMatrices(), item.getName().getString(), posX + 37, posY + 6, Render2DEngine.applyOpacity(-1, getFadeFactor()));
        FontRenderers.settings.drawString(context.getMatrices(), text, posX + 37, posY + 17, Render2DEngine.applyOpacity(new Color(0xFFBDBDBD, true).getRGB(), getFadeFactor()));
    }
