        ...
        Friend((EventSync e) -> {
            if (timer.every(800)) {
                if (mc.crosshairTarget instanceof EntityHitResult ehr && ehr.getEntity() instanceof PlayerEntity)
                    if (ThunderHack.friendManager.isFriend(ehr.getEntity().getName().getString())) {
                        ThunderHack.friendManager.removeFriend(ehr.getEntity().getName().getString());
                        ...
                        ThunderHack.friendManager.addFriend(ehr.getEntity().getName().getString());
